; loaded_object_event_struct members (see macros/wram.asm)
	const_def
...
; loaded_object_event_struct OBJECT_FACING values
OW_DOWN  EQU DOWN  << 2
OW_UP    EQU UP    << 2
OW_LEFT  EQU LEFT  << 2
OW_RIGHT EQU RIGHT << 2

; loaded_object_event_struct OBJECT_FLAGS1 bit flags
	const_def
	const INVISIBLE_F     ; 0
...
; loaded_object_event_struct OBJECT_FLAGS2 bit flags
	const_def
...
; loaded_object_event_struct OBJECT_PALETTE bit flags
	const_def 5
	const SWIMMING_F         ; 5
...
; object_event_struct struct members (see macros/wram.asm)
	const_def
